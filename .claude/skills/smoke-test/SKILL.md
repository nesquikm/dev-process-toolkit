...
--------------------------------------------------------------------------
retired raw regex (grep -Ec)                 2             0            0
`#26` (raw / assistant)                    2 / 1         2 / 1        2 / 1
...
staging itself stays off every other probe's radar.
