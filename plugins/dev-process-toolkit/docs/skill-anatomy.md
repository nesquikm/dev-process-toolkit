...
The toolkit's canonical read-only example is `skills/spec-review/SKILL.md`, which carries `allowed-tools: Read, Glob, Grep, Skill` because it audits specs against the codebase without ever editing; the other 24 skills omit the field by design.
