...
describe("AC-STE-380.7 — probe-count calibration stays coherent across surfaces", () => {
  test("highest numbered gate-check probe is 71 and README agrees", () => {
    ...
    expect(Number(counted![1])).toBe(71);
  });
});
