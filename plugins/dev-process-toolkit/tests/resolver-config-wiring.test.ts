...
// STE-44 AC-STE-44.5 conformance — the three resolver-calling skills must
...
// from any of these SKILL.md files regresses AC-STE-44.5.
...
describe("STE-44 AC-STE-44.5 — resolver-calling skills reference buildResolverConfig", () => {
