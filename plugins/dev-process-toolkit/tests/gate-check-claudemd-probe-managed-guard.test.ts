...
describe("AC-STE-434.6 — README documents 80 probes", () => {
  ...
  test("the Features bullet documents 80 numbered /gate-check probes (README.md:14)", () => {
    const readme = readFileSync(join(repoRoot, "README.md"), "utf-8");
    expect(onlyLine(readme, /numbered `\/gate-check` probes/)).toMatch(/\b80\b.*numbered/);
  });

  test("the /implement-invokes-/tdd aside documents 80 probes (README.md:109)", () => {
    const readme = readFileSync(join(repoRoot, "README.md"), "utf-8");
