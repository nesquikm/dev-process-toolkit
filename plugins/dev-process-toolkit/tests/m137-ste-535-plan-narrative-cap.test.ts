...
// by FILE PATH and never by line text, and a test below pins exactly that.
 ...
 */
function nonTestConsumers(
  moduleRel: string,
  searchRoot: string = PLUGIN_ROOT,
): ConsumerRef[] {
...
const consumerFiles = (moduleRel: string, searchRoot?: string): string[] => [
  ...new Set(
